...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="navier_stokes reduced-model ablation.")
    parser.add_argument("--equation", default="navier_stokes")
    parser.add_argument("--dataset", default="data/navier_stokes.npz")
    parser.add_argument("--output-root", default="runs/ablation/navier_stokes_reduced_model")
    parser.add_argument("--device", default="cuda:1")
    parser.add_argument("--reduced-model", default="navier_stokes_stokes_limit")
    ...
    parser.add_argument("--reduced-model-weight", type=float, default=0.05)
